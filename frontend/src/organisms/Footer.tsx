...
const Footer: FC = () => {
  return (
    <footer className="pt-16 bg-[rgb(112,110,235)] absolute inset-x-0 bottom-0">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-5 lg:gap-20 md:gap-6 sm:gap-12 gap-6  pb-16">
          <div className="col-span-2">
            <p className="text-xs font-medium text-grey dark:text-white/50 mt-5 mb-16 max-w-70%">
              Open an city in minutes, get full interest point with premium account
            </p>
          ...
          <div className="">
            <h4 className="text-black dark:text-white mb-9 font-semibold text-xl">Use cases</h4>
            <ul>
              <li className="pb-5">
                <Link
                  to="#"
          ...
          <div className="">
            <h4 className="text-black dark:text-white mb-9 font-semibold text-xl">Explore</h4>
            <ul>
              <li className="pb-5">
                <Link
                  to="#"
