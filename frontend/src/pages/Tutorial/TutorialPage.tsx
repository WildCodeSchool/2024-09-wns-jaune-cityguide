...
export default function TutorialPage() {
	...
	const isMobile = window.innerWidth < 640; //Check if device is a mobile based screen size

	const {
		interestPoints,
		selectedInterestPoint,
		setSelectedInterestPoint,
		fetchInterestPoints,
	...
	const stepsDesktop = [
		{
			...
			description:
				"Déjà inscrit ? Connecte-toi pour profiter de toutes les fonctionnalités !",
		...
		},
		{
			...
			description:
				"Rejoins-nous en quelques clics pour débloquer toutes les fonctionnalités du site.",
		...
		},
		{
			...
			description:
				"Explore la carte et clique sur un point d'intérêt pour en savoir plus. Chaque lieu cache des infos utiles, des anecdotes, et peut-être ta prochaine découverte coup de cœur.",
		...
		},
		{
			...
			description:
				"Tu veux explorer une ville en particulier ? Tape son nom ici et découvre en un clin d'œil tous les lieux à ne pas manquer. Pratique pour organiser tes visites !",
		},
		{
			selector: ".interest-point-details",
			title: "Fiche d'information",
			description:
				"Tu as sélectionné un lieu ? Voici tous les détails qui le concernent : description, infos pratiques, et pourquoi il mérite le détour. L'idéal pour préparer ta visite ou simplement satisfaire ta curiosité.",
			tooltipOffsetHeight: -250,
			tooltipOffsetWidth: 75,
			leftAdjustment: 47,
			action: () => setIsOpenInterestPoint(true),
		},
	];
