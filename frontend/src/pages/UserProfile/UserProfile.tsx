...
import { useDeleteUserMutation, useUpdateUserMutation } from "../../libs/graphql/generated/graphql-types";
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="shadow-md rounded-xl p-3 bg-white w-2xl">
              ...
              >
                ...
                <button
                  className={`w-full max-w-[150px] text-white py-1 rounded-[25px] bg-[#706eeb] hover:bg-[#b0afe4] transition ease-in-out duration-200 ${message ? "mt-0" : "mt-5"
                    }`}
                  type="submit"
                  ...
                  showModal && (
                    <div className="fixed inset-0 bg-opacity-40 flex items-center justify-center z-50 transition-opacity duration-300">
                      <div className={`
                        ...
                        <p className="mb-2">Veuillez entrer votre mot de passe pour confirmer :</p>
                        ...
                        {message && <p className="text-green-600 text-sm mb-2">{message.text}</p>}
            ...
            <div className="flex flex-col items-center w-2xl">
              <div className="shadow-md rounded-xl p-3 bg-white w-2xl px-7 mb-5">
                <h3 className="font-bold text-center mb-5">Ville de rattachement</h3>
                <div>
