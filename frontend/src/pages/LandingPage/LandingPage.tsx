    ...
    <div className="landing-page">
        <div className="container mx-auto px-6 py-16 text-center">
                    ...
                    <div className="container flex flex-col gap-4 mx-8">
                        <div className="primary-bg rounded-xl w-full h-auto py-4 flex flex-row justify-between divide-x divide-solid divide-gray-400">
                            <div className="relative flex-1 flex flex-col gap-2 px-4">
                                <label className="text-gray-800 text-base font-semibold tracking-wider">Nombre d'utilisateur</label>
                                <label className="text-white text-4xl font-bold">147</label>
                            </div>
                            <div className="relative flex-1 flex flex-col gap-2 px-4">
                                <label className="text-gray-800 text-base font-semibold tracking-wider">Nombre de ville</label>
                                <label className="text-white text-4xl font-bold">12</label>
                            </div>
                            <div className="relative flex-1 flex flex-col gap-2 px-4">
                                <label className="text-gray-800 text-base font-semibold tracking-wider">Nombre de point d'interêt</label>
                                <label className="text-white text-4xl font-bold">1OOO</label>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="mx-auto max-w-lg mt-20">
                ...
                className="mt-6 rounded-lg bg-blue-600 px-6 py-2.5 text-center text-sm font-medium capitalize leading-5 text-white hover:bg-blue-500 focus:outline-none lg:mx-0 lg:w-auto">Direction la map !</button>
            </div>
        </div>
    </div>
  )
