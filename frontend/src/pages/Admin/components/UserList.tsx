...
export default function UserList({ users, onSelect, showAll, onShowMore, userRefs, onShowLess }: Props) {
  ...
  return (
    <>
      ...
      {showAll && users.length > 19 && (
        ...
        >
          <span className="text-lg font-medium text-blue-600">Afficher moins</span>
